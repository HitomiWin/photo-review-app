...
const MyAlbumsList = () => {
  ...
  return (
    <>
      ...
      <Button variant="primary" className="text-button  text-center my-3" onClick={() => setCreateModalShow(true)} >
        Create an Album ?
      </Button>
      </div>
      <CreateAlbumForm show={createModalShow} onHide={() => setCreateModalShow(false)} />
      {query.isError && (
